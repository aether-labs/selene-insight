...
# Normalization stats for ALL Space-Track satellites.
# 11 features: [epoch_h, mm, ecc, incl, bstar, alt_km, dt_hours,
#               raan, argp, mean_anomaly, n_dot]
# B* clipped to [-1, 1]. Angular features (raan/argp/ma) in degrees [0,360).
